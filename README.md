...
For public release readiness, see `docs/repo-strategy.md`, `docs/mirror-removal-runbook.md`, `docs/commercial-boundary.md`, and `docs/public-release-checklist.md`.
